...
- (void)creatTableView
{
    ...
    UILabel *mineLab = [[UILabel alloc]initWithFrame:CGRectMake((WIDTH-20)/2, 10, 20, 20)];
    mineLab.text = @"我";
    mineLab.hidden = YES;
    ...
    UIImageView *mineImage = [[UIImageView alloc]initWithFrame:CGRectMake((WIDTH-50)/2, (WIDTH/1.8-50)/2-15, 50, 50)];
    ...
    UILabel *mineNameLab = [[UILabel alloc]initWithFrame:CGRectMake((WIDTH-120)/2, CGRectGetMaxY(mineImage.frame)+5, 120, 40)];
    mineNameLab.text = @"李玲玲";
    mineNameLab.textColor = [UIColor whiteColor];
    mineNameLab.textAlignment = NSTextAlignmentCenter;
    mineNameLab.font = [UIFont systemFontOfSize:22];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section==0&&indexPath.row==0) {
        ...
        UIImageView *iconImage = [[UIImageView alloc]initWithFrame:CGRectMake(16, 5, 34, 34)];
        iconImage.layer.cornerRadius = 17;
        iconImage.layer.masksToBounds = YES;
        [iconImage sd_setImageWithURL:[NSURL URLWithString:[UserInfo share].avatorUrl] placeholderImage:[UIImage imageNamed:@"list_user"]];
        ...
        [addCaseBtn setTitle:@"添加新设备" forState:UIControlStateNormal];
        [addCaseBtn setTitleColor:AppThemeColor forState:UIControlStateNormal];
        addCaseBtn.titleLabel.font = [UIFont systemFontOfSize:15];
